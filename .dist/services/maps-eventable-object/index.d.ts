...
export declare type MapsObjectHandlerName = 'onClick' | 'onDblClick' | 'onDrag' | 'onDragStart' | 'onDragEnd' | 'onMouseOut' | 'onMouseOver' | 'onRightClick';
export declare type MapsObjectEventName = 'click' | 'dblclick' | 'drag' | 'dragstart' | 'dragend' | 'mouseout' | 'mouseover' | 'rightclick';
