...
export declare const MapConsumer: React.ExoticComponent<React.ConsumerProps<MapService | undefined>>;
export declare const CreateMapConsumer: React.ExoticComponent<React.ConsumerProps<CreateMapCtxValue | undefined>>;
